...
class MatrixScreenState extends State<MatrixScreen>
  ...
  initState() {
    ...
    controller.addListener(() {
      if (controller.position.maxScrollExtent == controller.position.pixels) {
        matrixController.pendingApi(2);
        matrixController.update();
        print(
            'object ${matrixController.pendingList[0].data!.trainingList![0].title}');
      }
    });
    super.initState();
  }

  final matrixController = Get.put(MatrixListController());
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
        init: MatrixListController(),
        builder: (p) {
          return matrixController.allList.isEmpty
              ? Scaffold(
                    ...
                    child: Card(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(
                            Constant.EXTRA_LARGE_PADDING * 2),
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: SizedBox(
                                      height: landscap
                                          ? mediawidth /
                                              Constant.ladscapappbarHight
                                          : mediahight /
                                              Constant.potraitappbarHight,
                                      width: mediawidth,
                                      child: const Image(
                                ...
                                title: matrixController.convert
                                    ? Padding(
                                        ...
                                        child: SizedBox(
                                          height: landscap
                                              ? Constant
                                                  .landscapsearchBarHeight.w
                                              : Constant
                                                  .potraitsearchBarHeight.h,
                                          width: landscap
                                              ? Constant
                                                  .landscapsearchBarwidth.w
                                              : Constant
                                                  .potraitsearchBarwidth.h,
                                          child: TextFormField(
                                ...
                                child: Column(
                                  children: [
                                    Container(
                                      height: landscap
                                          ? Constant
                                              .landscapdrawerWidget1height.w
                                          : Constant
                                              .potraitdrawerWidget1height.h,
                                      decoration: BoxDecoration(
                                      ...
                                      Container(
                                        ...
                                        child: TabBar(
                                            ...
                                            labelStyle: TextStyle(
                                                fontSize: landscap
                                                    ? Constant
                                                        .landscaptabbarlabelSize
                                                        .w
                                                    : Constant
                                                        .potraittabbarlabelSize
                                                        .h),
                                            indicatorSize:
              ...
              itemBuilder: (context, index) {
                return SizerUtil.deviceType == DeviceType.tablet
                    ? trainingMatrixList(
                        ...
                        trainignumber:
                            trainingList[index].trainingNo.toString())
                    : trainingMatrixList(
                        context: context,
                        index: index,
                        title: trainingList[index].title.toString(),
